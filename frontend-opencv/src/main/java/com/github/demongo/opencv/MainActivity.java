...
import hpi.gitlab.demongo.pipeline.BlurEstimationStep;
import hpi.gitlab.demongo.pipeline.BrandDetectionStep;
import hpi.gitlab.demongo.pipeline.ContourDetectionStep;
import hpi.gitlab.demongo.pipeline.NoiseEstimationStep;
import hpi.gitlab.demongo.pipeline.SendingStep;
import hpi.gitlab.demongo.pipeline.Snapshot;
import hpi.gitlab.demongo.pipeline.Step;
